...
describe "building a multidimensional monopoly hash" do
  ...
  describe "fourth level of monopoly hash" do
    describe "#monopoly_with_fourth_tier" do
      xit "sets the 1st key of the :reading_railroad hash to a string, 'mortgage_value', whose value is '$100'" do
      ...
      xit "sets the 1st key of the :pennsylvania_railroad hash to a string, 'mortgage_value', whose value is '$200'" do
      ...
      xit "sets the 1st key of the :b_and_o_railroad hash to a string, 'mortgage_value', whose value is '$400'" do
      ...
      xit "sets the 1st key of the :shortline hash to a string, `mortgage_value`, whose value is '$800'" do
